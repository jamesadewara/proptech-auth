...
from .views import InviteAcceptView, InviteCreateView, MeView, PasswordForgotView, PasswordResetView, RegisterTenantView, LogoutView, TenantTokenObtainPairView, DeleteAccountView, RemoveStaffView
...
urlpatterns = [
    ...
    path('delete/account/', DeleteAccountView.as_view(), name='logout'),
